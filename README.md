...
| `new-reservation.html` | **New Reservation — 4-step guided wizard** | Steps: Guest & Source → Stay & Rooms → Pricing & Payment → Review & Save. See §8.1 for detail. Supports `?demo=ahmad-whatsapp` to pre-fill the Guided Journey scenario. |
